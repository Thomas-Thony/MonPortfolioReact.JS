          ...
          <div className="gallery">
            <div className="fonctionImage">
              <img
                ...
                src="/certfs/CNIL/PNG/Certificat_module1_thomas-thony.png"
                alt="Certificat module 1"
                />
              <div className="millieu_cnil">
                <div className="text_cnil">
                  <a
                    href="/certfs/CNIL/PNG/Certificat_module1_thomas-thony.png"
        ...
        <div className="responsive">
          <div className="gallery">
            <div className="fonctionImage">
              <img
                className="certif_cnil"
                src="/certfs/CNIL/PNG/Certificat_module2_thomas-thony.png"
                alt="Certificat module 2"
              />
              <div className="millieu_cnil">
                <div className="text_cnil">
                  <a
                    href="/certfs/CNIL/PNG/Certificat_module2_thomas-thony.png"
        ...
        <div className="responsive">
          <div className="gallery">
            <div className="fonctionImage">
              <img
                className="certif_cnil"
                src="/certfs/CNIL/PNG/Certificat_module3_thomas-thony_1.png"
                alt="Certificat module 3"
              />
              <div className="millieu_cnil">
                <div className="text_cnil">
                  <a
                    href="/certfs/CNIL/PNG/Certificat_module3_thomas-thony_1.png"
        ...
        <div className="responsive">
          <div className="gallery">
            <div className="fonctionImage">
              <img
                className="certif_cnil"
                src="/certfs/CNIL/PNG/Certificat_module4_thomas-thony.png"
                alt="Certificat module 4"
              />
              <div className="millieu_cnil">
                <div className="text_cnil">
                  <a
                    href="/certfs/CNIL/PNG/Certificat_module4_thomas-thony.png"
        ...
        <div className="responsive">
          <div className="gallery">
            <div className="fonctionImage">
              <img
                className="certif_cnil"
                src="/certfs/CNIL/PNG/Certificat_module5_thomas-thony.png"
                alt="Certificat module 5"
              />
              <div className="millieu_cnil">
                <div className="text_cnil">
                  <a
                    href="/certfs/CNIL/PNG/Certificat_module5_thomas-thony.png"
